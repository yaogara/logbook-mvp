...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    ...
    >
        ...
        <div className="mx-auto max-w-5xl px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <nav className="hidden sm:flex items-center gap-1">
              <Link
                to="/"
                className={`px-3 py-1.5 rounded-full text-sm transition ${isHome
              ...
              <Link
                to="/history"
                className={`px-3 py-1.5 rounded-full text-sm transition ${isHistory
                    ? 'bg-[rgb(var(--card-hover))] text-[rgb(var(--fg))]'
                    : 'text-[rgb(var(--muted))] hover:text-[rgb(var(--fg))]'
                  }`}
              >
              ...
              <Link
                to="/dashboard"
                className={`px-3 py-1.5 rounded-full text-sm transition ${isDash
                    ? 'bg-[rgb(var(--card-hover))] text-[rgb(var(--fg))]'
                    : 'text-[rgb(var(--muted))] hover:text-[rgb(var(--fg))]'
                  }`}
              >
              ...
              <Link
                to="/contributors"
                className={`px-3 py-1.5 rounded-full text-sm transition ${isContributors
                    ? 'bg-[rgb(var(--card-hover))] text-[rgb(var(--fg))]'
                    : 'text-[rgb(var(--muted))] hover:text-[rgb(var(--fg))]'
                  }`}
              >
              ...
              <div className="relative">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full text-sm transition flex items-center gap-1 ${isEggs
                      ? 'bg-[rgb(var(--card-hover))] text-[rgb(var(--fg))]'
                      : 'text-[rgb(var(--muted))] hover:text-[rgb(var(--fg))]'
                    }`}
                >
                ...
                {huevosDropdownOpen && (
                  <div className="absolute top-full left-0 mt-1 bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-lg shadow-lg py-1 min-w-[140px] z-50">
                    <Link
                      ...
                      className={`block px-3 py-2 text-sm transition ${loc.hash === '#production'
                          ? 'bg-[rgb(var(--card-hover))] text-[rgb(var(--fg))]'
                    ...
                    <Link
                      to="/eggs#outflows"
                      onClick={() => setHuevosDropdownOpen(false)}
                      className={`block px-3 py-2 text-sm transition ${loc.hash === '#outflows'
                          ? 'bg-[rgb(var(--card-hover))] text-[rgb(var(--fg))]'
                          : 'text-[rgb(var(--muted))] hover:text-[rgb(var(--fg))] hover:bg-[rgb(var(--card-hover))]'
                        }`}
                    >
          ...
          <div className="flex items-center gap-3">
            <span
              className={`sm:hidden inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-medium transition ${online ? 'bg-[rgb(var(--primary))]/15 text-[rgb(var(--primary))]' : 'bg-[rgb(var(--card-hover))] text-[rgb(var(--muted))]'
                }`}
              title={online ? 'Sincronizado' : 'Sin conexión'}
            >
              <span
                className={`block h-2 w-2 rounded-full ${online ? 'bg-[rgb(var(--primary))]' : 'bg-[rgb(var(--muted))]'
                  }`}
              />
      ...
      {/* MAIN CONTENT */}
      <main className="pt-24 flex-1 mx-auto w-full max-w-5xl px-4 py-6 pb-24 sm:pb-6">
        {children}
      </main>
      ...
      >
        <div className="flex items-center justify-around px-2 py-2">
          <Link
            to="/"
            className={`px-4 py-2 rounded-full text-sm font-medium transition ${isHome
                ? 'bg-[rgb(var(--card-hover))] text-[rgb(var(--fg))]'
                : 'text-[rgb(var(--muted))]'
              }`}
          >
          ...
          <Link
            to="/history"
            className={`px-4 py-2 rounded-full text-sm font-medium transition ${isHistory
                ? 'bg-[rgb(var(--card-hover))] text-[rgb(var(--fg))]'
                : 'text-[rgb(var(--muted))]'
              }`}
          >
          ...
          <Link
            to="/dashboard"
            className={`px-4 py-2 rounded-full text-sm font-medium transition ${isDash
                ? 'bg-[rgb(var(--card-hover))] text-[rgb(var(--fg))]'
                : 'text-[rgb(var(--muted))]'
              }`}
          >
          ...
          <Link
            to="/contributors"
            className={`px-4 py-2 rounded-full text-sm font-medium transition ${isContributors
                ? 'bg-[rgb(var(--card-hover))] text-[rgb(var(--fg))]'
                : 'text-[rgb(var(--muted))]'
              }`}
          >
